...
app.get("/equipments", auth, (req, res) => {
  res.render("equipments/viewAllEquipment", { res });
});

app.get("/labs", auth, (req, res) => {
  res.render("lab/viewAllLab.ejs", { res });
});

app.get("/bookings", auth, (req, res) => {
  res.render("booking/viewAllBooking", { res });
});
